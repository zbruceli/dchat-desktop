...
const NAV_ITEMS: { id: NavItem; label: string; icon: string }[] = [
  ...
  { id: "discover", label: "Discover", icon: "M21 12a9 9 0 11-18 0 9 9 0 0118 0z M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707" },
